...
public class AuthFixture {
    ...
    public static final String ACCESS_TOKEN = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0ZXN0ZXIxMjMiLCJhdXRoIjoiUk9MRV_Q1VSTE9NRVIiLCJpYXQiOjE3MTI3MTIzNDUsImV4cCI6MTcxMjcxNTk0NX0.mock-signature";
    public static final String REFRESH_TOKEN = "def-456-refresh-token-mock";

    public static SignupRequest createSignupRequest() {
        CreateUserAddressRequest address = CreateUserAddressRequest.from(
                "11", "서울특별시", "11680", "강남구", "1168010100", "역삼동",
                "서울특별시 강남구 테헤란로 427", "위워크 타워 10층", "회사"
        );
